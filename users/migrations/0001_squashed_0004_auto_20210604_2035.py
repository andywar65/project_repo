# Generated by Django 3.1.2 on 2021-06-23 10:47
...
class Migration(migrations.Migration):
    ...
    replaces = [('users', '0001_initial'), ('users', '0002_auto_20210604_2003'), ('users', '0003_auto_20210604_2020'), ('users', '0004_auto_20210604_2035')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254, null=True, verbose_name='Modulo')),
        ...
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('user', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='users.user')),
                ...
                ('yes_spam', models.BooleanField(default=False, help_text="Vuoi essere notificato dell'uscita di nuovi articoli?", verbose_name='Mailing list')),
                ...
                ('zoom', models.FloatField(default=10, help_text='10 is good for a large city', verbose_name='Fattore di zoom')),
            ],
            options={
