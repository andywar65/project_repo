    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro', models.CharField(default=blog.models.default_intro, max_length=100, verbose_name='Introduzione')),
                ...
                ('notice', models.CharField(blank=True, choices=[('NOSP', 'Non inviare'), ('SPAM', 'Da inviare'), ('DONE', 'Già inviata')], help_text="Invia una notifica automatica selezionando\n            'Invia notifica' e salvando l'articolo\n            ", max_length=4, null=True, verbose_name='Notifica per email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.CharField(help_text='Scrivi qualcosa', max_length=500, verbose_name='Testo')),
